        ...
        if (world.game_state == Game_State.Playing)
        {
            ...
            if (!isbroking)
            {
                ...
                if (Input.GetMouseButton(0))
                {
                    ...
                    MC_RayCastStruct _rayCast = MC_Tool_Raycast.RayCast(managerhub, MC_RayCast_FindType.OnlyFindBlock,player.cam.position, player.cam.transform.forward, player.reach, -1, 0.1f);
