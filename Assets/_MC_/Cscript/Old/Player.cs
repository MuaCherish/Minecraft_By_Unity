...
public class Player : MonoBehaviour
{
    ...
    private void GetPlayerInputs()
    {
        ...
        //飞行模式
        if (MC_Runtime_DynamicData.instance.GetGameMode() == GameMode.Creative && !isSpectatorMode)
        {
        ...
        if (Input.GetMouseButtonDown(0) && !isSpectatorMode)
        {
            ...
            if (_rayCast.isHit == 2)
            {
                ...
                //播放玩家攻击音效
                managerhub.Service_Music.PlayOneShot(MusicData.Player_Attack);
                ...
                //if (_index != 0)
                //    managerhub.Service_Music.PlayOneShot(_index);
                    ...
                    switch (_targettype)
                    {
                        ...
                        case 40:
                            if (_selecttype == VoxelData.Tool_MusicDiscs)
                            {
                                ...
                                //managerhub.Service_Music.SwitchBackgroundMusic(MusicData.MusicBox, 1f, 0.5f);
                                managerhub.Service_Music.Create3DSound(GetCenterVector3(_rayCast.hitPoint_Previous) , MusicData.MusicBox);
