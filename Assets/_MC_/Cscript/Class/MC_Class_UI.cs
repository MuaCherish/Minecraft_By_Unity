...
public static class CanvasData
{
    ...
    //ui选项细节宏定义
    public static readonly int ui视频设置 = 0;
    public static readonly int ui音乐与声音 = 1;
    public static readonly int ui昼夜模式 = 2;
    public static readonly int ui玩家设置 = 3;
    public static readonly int ui辅助设置 = 4;
