...
public class SunMoving : MonoBehaviour
{
    ...
    void SunMoon_Moving()
    {
        ...
        time = managerhub.Service_Time.GetCurrentTime();
    ...
    {
        float newIntensity = Mathf.Lerp(0f, 1.7f, managerhub.Service_Time.gameTime._value);
    ...
    {
        float result = 4 * Mathf.Pow(managerhub.Service_Time.gameTime._value - 0.5f, 2);
