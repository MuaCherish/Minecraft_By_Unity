...
public class CanvasManager : MonoBehaviour
{
    ...
    void Handle_GameState_Playing()
    {
        ...
        //Creative
        else if (MC_Runtime_DynamicData.instance.GetGameMode() == GameMode.Creative)
        {
            GameMode_Creative();
        }
    ...
    void Handle_GameState_Pause()
    {
        ...
        if (Input.GetKeyDown(KeyCode.E) && isOpenBackpack && !managerhub.chatManager.isInputing && !managerhub.player.isSpectatorMode)
        {
            ...
            SwitchUI_Player(-1);
            MC_Runtime_DynamicData.instance.SetGameState(Game_State.Playing);
    ...
    public void SwitchToUI(int _TargetID)
    {
        ...
        if (UpdateCanvasState(_TargetID))
        {
            ...
            managerhub.Service_Music.PlayOneShot(MusicData.click);
        }
    ...
    public bool UpdateCanvasState(int _TargetID)
    {
        ...
        else if (_TargetID == CanvasData.ui加载世界)
        {
            ...
            else
            {
                ...
                //游戏状态切换
                MC_Runtime_DynamicData.instance.SetGameState(Game_State.Loading);
    ...
    public void Compoments_SaveWorldSettings(int _id)
    {
        ...
        switch (_id)
        {
            ...
            case 3:
                ...
                {
                    //改为创造模式
                    MC_Runtime_DynamicData.instance.SetGameMode(GameMode.Creative);
    ...
    public void Compoments_MusicSettings(int _id)
    {
        ...
        switch (_id)
        {
            ...
            case 0:
                ...
                //Update
                managerhub.Service_Music.SetVolumn(Mathf.Lerp(0f, 1f, value));
    ...
    public void SwitchUI_Player(int _index)
    {
        ...
        if (_index != -1)
        {
            if (isPausing == false)
            {
                ...
                MC_Runtime_DynamicData.instance.SetGameState(Game_State.Pause);
            }
        }
        //关闭UI
        else
